...
def process_ply_to_csv(ply_path, output_csv_path):
    # Open3D for geometry
    ...
    # Try to extract labels using plyfile
    labels = extract_labels_with_plyfile(ply_path)
...
def process_all_plys(input_dir, output_dir):
    ...
    for file in tqdm(files):
        ...
        process_ply_to_csv(in_path, out_path)

# Example paths
input_ply_dir = '/Users/shrikar/Library/Mobile Documents/com~apple~CloudDocs/Sem IV/R&D/RnD/Trials/Python/grids_2.5/grids_2.5_ply'
output_csv_dir = '/Users/shrikar/Library/Mobile Documents/com~apple~CloudDocs/Sem IV/R&D/RnD/Trials/Python/grids_2.5/grids_2.5_labels'
process_all_plys(input_ply_dir, output_csv_dir)
