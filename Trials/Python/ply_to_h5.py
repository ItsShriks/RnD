...
def process_ply_files(input_dir, output_dir):
    ...
    for file in tqdm(files):
        ...
        h5_path = os.path.join(output_dir, file.replace(".ply", ".h5"))
...
output_dir = '/Users/shrikar/Library/Mobile Documents/com~apple~CloudDocs/Sem IV/R&D/RnD/Trials/Python/grids_2.5/h5'
